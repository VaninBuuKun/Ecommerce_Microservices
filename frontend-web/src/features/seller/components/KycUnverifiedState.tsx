...
import { useWalletQuery } from "../../order/hooks/useCheckoutQueries";
		...
		<div className="text-center py-4">
			{walletLoading ? (
				...
				<>
					...
					<h2 className="text-base font-bold text-brand-dark mb-2 uppercase tracking-wide">
						Yêu cầu kích hoạt ví điện tử
					</h2>
					<p className="text-xs text-brand-muted mb-6 leading-relaxed max-w-md mx-auto">
