...
import { ShippingAddressTab } from "../components/profile/ShippingAddressTab";
import { MyOrdersTab } from "../components/profile/MyOrdersTab";
import { WalletTab } from "../components/profile/WalletTab";
import { RefundRequestsTab } from "../components/profile/RefundRequestsTab";
		...
		<div className="max-w-6xl mx-auto px-4 py-8 font-sans text-left min-h-[75vh]">
			<div className="flex flex-col md:flex-row gap-6">
				...
				<div className="flex-1 bg-white border border-brand-border rounded-2xl p-6 shadow-sm min-h-[60vh]">
					...
					{activeTab === "orders" && (
						<MyOrdersTab customerId={user?.id} />
					)}
					{activeTab === "wallet" && (
						<WalletTab />
					)}
