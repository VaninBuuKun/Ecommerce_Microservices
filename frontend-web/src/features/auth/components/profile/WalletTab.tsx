...
import { WithdrawRequestsTable } from "./components/WithdrawRequestsTable";
import { WalletTransactionsTable } from "./components/WalletTransactionsTable";
import { BankAccountManagerModal } from "./components/BankAccountManagerModal";
import { WithdrawRequestModal } from "./components/WithdrawRequestModal";
import { WalletActivationForm } from "./components/WalletActivationForm";
...
export function WalletTab() {
	...
	// Query ngân hàng, giao dịch & yêu cầu rút tiền
	...
	// Sub-Tabs States ("withdrawals" | "transactions")
