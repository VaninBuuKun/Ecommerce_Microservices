...
import { Loader2, RefreshCw, History, DollarSign, Wallet, ArrowDownRight, ArrowUpRight } from "lucide-react";
...
export function AdminWalletsDashboardView() {
	...
	// Stats
	const totalRevenue = 125000000; // Tĩnh theo yêu cầu (Doanh thu)
