...
export function CreateProductModal({ open, onClose, shopId }: CreateProductModalProps) {
	...
	return (
		<div className="fixed inset-0 z-50 flex items-center justify-center font-sans text-xs">
			...
			<div className="absolute left-1/2 top-1/2 w-full max-w-md -translate-x-1/2 -translate-y-1/2 rounded-md bg-white shadow-xl border border-brand-border overflow-hidden">
				...
				<div className="space-y-4 p-4 text-left">
					<div>
						...
						<input
							...
							className="w-full h-8 px-3 border border-brand-border rounded-md focus:outline-none focus:border-brand-primary"
						/>
					</div>
					...
					<div>
						...
						<textarea
							...
							className="w-full p-2 border border-brand-border rounded-md focus:outline-none focus:border-brand-primary text-xs"
						/>
					</div>
				...
				<div className="flex justify-end gap-2 border-t border-brand-border p-4 bg-brand-light-soft">
					<button
						onClick={onClose}
						disabled={isPending}
						className="px-3 py-1.5 border border-brand-border rounded-md hover:bg-gray-50 cursor-pointer font-semibold"
					>
						Hủy
					</button>
					...
					<button
						...
						disabled={isPending}
						className="px-3 py-1.5 bg-brand-primary hover:bg-brand-primary-deep text-brand-dark rounded-md font-bold flex items-center gap-1 cursor-pointer disabled:opacity-65"
					>
