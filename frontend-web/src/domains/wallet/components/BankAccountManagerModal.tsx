import { X, PlusCircle, Check, Edit } from "lucide-react";
...
export function BankAccountManagerModal({
	...
	return (
		<div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-brand-dark/40 backdrop-blur-xs font-sans">
			<div className="bg-white rounded-2xl max-w-xl w-full border border-brand-border p-6 shadow-2xl space-y-4 text-left">
				...
				{showAddForm ? (
					<form onSubmit={onAddSubmit} className="space-y-3 bg-brand-light-soft/50 p-4 border border-brand-border rounded-xl text-xs">
