...
import { Mail, ArrowLeft, CheckCircle2, Loader2, Lock, Eye, EyeOff, ShieldCheck, Terminal } from "lucide-react";
					...
					{isSuccess ? (
						...
						<form onSubmit={handleResetPassword} className="space-y-3">
							...
							<p className="text-center text-xs text-brand-muted pt-1">
								<Link
									to="/login"
									className="text-brand-muted hover:text-brand-dark hover:underline"
								>
									← Quay lại đăng nhập
								</Link>
							</p>
