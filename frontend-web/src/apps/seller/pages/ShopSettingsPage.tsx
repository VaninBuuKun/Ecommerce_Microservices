...
import { useSellerProfileQuery, useUpdateShopMutation, useShopDetailQuery, useSellerStore } from "@/domains/seller";
import {
	useProvincesQuery,
	useDistrictsQuery,
	useWardsQuery,
...
export function ShopSettingsPage() {
	...
	const resolvedShop = shopDetail || activeShop || profile?.shops.find((shop: any) => String(shop.id) === shopId);
