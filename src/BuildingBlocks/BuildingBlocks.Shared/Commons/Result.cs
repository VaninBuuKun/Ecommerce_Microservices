...
public class ResultBase
{
    ...
    [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
    public object? Errors { get; protected init; }
    
    [JsonIgnore]
    public EErrorCode ErrorCode { get; protected init; }
...
public class Result :  ResultBase
{
    ...
    public static Result Failure(ResultBase other) 
    {
        return new Result
        { 
            IsSuccess = false, 
...
public class Result<T> : ResultBase
{
    ...
    public static Result<T> Failure(string? message, EErrorCode eError = EErrorCode.ValidationErrors, object? errors = null) => 
    ...
    public static Result<T> Failure(ResultBase other) 
    {
        return new Result<T> 
        { 
            IsSuccess = false, 
