...
public class SellerConfirmSubOrderCommandHandler(
    IEfUnitOfWork unitOfWork,
    IEventPublisher publisher,
    ISellerService sellerService,
    ILogger<SellerConfirmSubOrderCommandHandler> logger)
    : CommandHandler<SellerConfirmSubOrderCommand>
{
    protected override async Task<Result> HandleCommandAsync(SellerConfirmSubOrderCommand command, CancellationToken cancellationToken)
    {
