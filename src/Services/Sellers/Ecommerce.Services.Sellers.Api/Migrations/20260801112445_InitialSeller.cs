        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PickUp_ProvinceId = table.Column<long>(type: "bigint", nullable: false),
                    PickUp_DistrictId = table.Column<long>(type: "bigint", nullable: false),
                    PickUp_WardId = table.Column<long>(type: "bigint", maxLength: 20, nullable: false),
                    Status = table.Column<int>(type: "integer", nullable: false),
                    GhnShopId = table.Column<string>(type: "text", nullable: true),
                    CreatedDate = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    LastModifiedDate = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: true)
                },
                constraints: table =>
